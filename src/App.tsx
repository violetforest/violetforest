      ...
      <AnimatePresence mode="wait">
        <Suspense key={location.pathname} fallback={null}>
          <Routes location={location}>
            ...
            <Route path="/girly" element={<NetArtIframe src={`${import.meta.env.BASE_URL}girly/bedroom.html`} title="girly" showNext={false} favicon={`${import.meta.env.BASE_URL}girly/favicon.ico`} />} />
