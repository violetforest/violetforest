        ...
        <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '2rem 1rem 0' }}>
          ...
          <AnimatePresence>
            {aboutVisible && (
              ...
              >
                <p style={{ opacity: 0.7 }}>
                  if you've ever wondered what its like being in my mind allday, this is it. loops looping over and over and over of the 50 most recent tracks I've liked on soundcloud. this updates automatically whenever i like a new track.
                </p>
                <span
